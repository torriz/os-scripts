#!/bin/bash
#-Metadata----------------------------------------------------#
#  Filename: debian.sh                   (Update: 01-07-2016) #
#-Info--------------------------------------------------------#
#  Personal post-install script for Debian 8.x 64-bit         #
#-Author(s)---------------------------------------------------#
#  g0tmilk ~ https://blog.g0tmi1k.com/                        #
#  torriZ ~ @torriZcs - github.com/torriZ					  #
#-Operating System--------------------------------------------#
#  Designed for: Debian 8.x [x64] (VM - VMware)   	          #
#  Originally Designed for: Kali Linux 2.x [x64] (VM - VMware)#
#     Tested on: Kali Linux 2.0.0 x64/x84/full/light/mini/vm  #
#     Debian 8.x: Testing atm							      #
#-Licence-----------------------------------------------------#
#  MIT License ~ http://opensource.org/licenses/MIT           #
#-Notes-------------------------------------------------------#
#  Run as root, just after a fresh install of Debian 8.x. 	  #
#                             ---                             #
...
#                                                             #
#    e.g. # bash debian.sh -osx -burp keyboard gb			  #
#                             ---                             #
...
##### Install gparted
#--- Do we need this if it's a VM? (do a VM check here)
...
##### Install Python (Windows via WINE) *** WINE is too dated =(  (try again with debian 8 / kali 2.0) <- I'm trying.
...
echo -e " ${YELLOW}[i]${RESET} + ${YELLOW}Change default passwords${RESET}: PostgreSQL, MySQL, etc"
